...
export class ItemBoxComponent {
  ...
  {src:"assets/icons/c_logo.png", title: "The C Programming Language"},{src:"assets/icons/C++_Logo.png", title: "C++"},{src:"assets/icons/csharp_logo.png", title: "C#"},{src:"assets/icons/angular_logo.png", title: "Angular"},
  {src:"assets/icons/scss_logo.png", title: "SCSS"}, {src:"assets/icons/tailwind_logo.png",title:"Tailwind CSS"},
  ...
  {src:"assets/icons/bottle_icon_w:o_bg.png", title: "Bottle Web Framework"},{src:"assets/icons/sqlite-square-icon.png", title: "SQLite3"}, {src:"assets/icons/mongo_db_logo.png", title:"MongoDB"},
