...
export class ProjectsComponent {
  projects = [
    ...
    {title:"tcp chat application", detail1:"february 2024 - march 2024", detail2:"engineered a sophisticated chat application based on the server-client model using tcp sockets. allowed for additional commands by leveraging the use of non-blocking i/o."},
    ...
    {title:"pos system", detail1:"february 2021", detail2:"designed a point-of-sale system using object-oriented programming to switch states and incorporate different functionalities, utilizing polymorphism and inheritance to manage the user's cart and item information."},
