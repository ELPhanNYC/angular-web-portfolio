...
export class WorkComponent {
  positions = [
    {title:"research assistant @ northeastern university", detail1:"summer 2024 - present | remote | python, selenium", detail2:"configured a python and selenium-based system to scrape 56 facebook pages, storing data in mysql database for nlp analysis of misinformation causes.", links:""},
